#ifndef SIMPLEMETEOSTATION_APPLICATION_CONFIG_APP_CONFIG_H_
#define SIMPLEMETEOSTATION_APPLICATION_CONFIG_APP_CONFIG_H_
...
#endif //SIMPLEMETEOSTATION_APPLICATION_CONFIG_APP_CONFIG_H_
